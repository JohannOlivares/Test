...
class _WeeklyGoalSetScreenState extends State<WeeklyGoalSetScreen> {
      ...
      child: Container(
        ...
        child: Column(
          children: [
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    Container(
                      child: Text(
                        Languages.of(context).txt150MinBriskWalking.toUpperCase(),
                        style: TextStyle(
                            fontWeight: FontWeight.w700,
                            color: Colur.txt_white,
                            fontSize: 20),
            ...
            //Info Container
            Expanded(
              child: Container(margin: EdgeInsets.only(left: fullWidth*0.06,top: fullHeight*0.05),
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        Languages.of(context).txtYouCanCombineTheseTwoDescription,maxLines: 2,
                        style: TextStyle(
                            fontWeight: FontWeight.w500,
                            fontSize: 16,
                            color: Colur.txt_grey),
  ...
  _distanceUnitTab([double fullHeight]) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: Colur.progress_background_color, width: 1.5),
        color: Colur.common_bg_dark,
      ),
      child: Row(
            ...
            child: Container(
              ...
              child: Center(
                child: Text(
                  ...
                  style: TextStyle(
                      color: KmSelected ? Color(0xFF9195B6) : Colur.white,
                      fontWeight: FontWeight.w500,
                      fontSize: 18),
                ),
              ),
  ...
  Widget _setAsMyGoalButton() {
    return Container(
      margin: EdgeInsets.only(left: 60, bottom: 80, right: 60),
        ...
        children: [
          ...
          Container(
            ...
            child: CupertinoPicker(
              ...
              itemExtent: 75.0,
              children: unit == "MILE" ? List.generate(2155, (index) {
                index+=1;
                return Text(
                  "$index",
                  style: TextStyle(
          ...
          (unit == "KM")?Container(
            ...
            child: Text(Languages.of(context).txtKM,style: TextStyle(color: Colur.txt_white,fontSize: 20,fontWeight: FontWeight.w500),),
          ):Container(
            margin: EdgeInsets.only(left: 5),
            child: Text(Languages.of(context).txtMILE,style: TextStyle(color: Colur.txt_white,fontSize: 20,fontWeight: FontWeight.w500),),
          ),
        ],
      ),
    );
