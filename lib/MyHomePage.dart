...
/*  _getImageAndStore(File file, Uint8List imageBytes) async {
    setState(() {
      loading = true;
    });


    bool downloaded = await saveFile(imageBytes,"${DateTime.now().millisecond}");
    if(downloaded)
      {
        Debug.printLog("File Downloaded");
      }
    else{
      Debug.printLog("Problem Downloading File");
    }
